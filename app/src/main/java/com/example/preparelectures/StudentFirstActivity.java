...
public class StudentFirstActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(e==null) {
                    if (documentSnapshot.exists()) {
                        ...
                        editor.putString("StudentProfile",json);
                        editor.commit();
                    }
                }
                else
    ...
    void logout()
    {
        if(sharedPreferences.getString("StudentProfile","")!="") {
            sharedPreferences.edit().remove("StudentProfile").commit();
            if (sharedPreferences.getString("StudentProfile", "") == "") {
                Toast.makeText(this, "StudentProfile", Toast.LENGTH_LONG).show();
